        ...
        <div class="p-4">
            ...
            <div class="mb-3 d-flex flex-column gap-3">
                <div class="w-fit">
                    ...
                    <a href="<?= BASEURL; ?>/user/indexRestore" class="btn btn-warning">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="CreateUserModalLabel">Create Account</h1>
                ...
                <div class="w-50">
                    <form action="<?= BASEURL; ?>/user/index" method="post" class="d-flex">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownUserMenuButton<?= $user['id']; ?>">
                                            ...
                                            <li>
                                                <a class="dropdown-item text-danger"
                                                    href="<?= BASEURL; ?>/user/delete/<?= $user['id']; ?>"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= BASEURL; ?>/user/update" method="post">
                                                ...
                                                <div class="mb-3">
                                                    <label for="Instance" class="form-label">Instance</label>
                                                    <select class="form-select" id="Instance" name="instance_id" required>
                                                        <?php
                                                        if ($user['instance_id'] == '1') {
